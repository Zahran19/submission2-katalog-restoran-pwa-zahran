...
import { renderRestaurants } from '../templates/template-creator'; // Assuming this function exists to render restaurant items
...
const Restaurants = {
  ...
  async afterRender() {
    try {
      ...
      document.getElementById('restaurant-list').innerHTML = '<li>Failed to load restaurants.</li>';
    }
  },
};
